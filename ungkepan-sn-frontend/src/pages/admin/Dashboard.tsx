    ...
    ? [
        {
          ...
          svg: (
            <path d="M21 8V7l-3-4H6L3 7v1M21 8v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8M21 8H3M12 12h4" />
          ),
        },
        {
          label: "Total Pesanan",
    ...
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <div className="bg-white rounded-2xl p-6 sm:p-7">
              ...
              {(() => {
                ...
                return total > 0 ? (
                  ...
                  <p className="mt-5 text-sm text-zinc-400 py-10 text-center">
                    Belum ada produk
                  </p>
                );
              })()}
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-7">
                          ...
                          <div className="flex-1 relative">
                            <div className="absolute inset-0 flex items-end rounded-t-md overflow-hidden">
                              <div
                                ...
                                style={{
                                  height: `${h}%`,
                                  minHeight: m.value > 0 ? 6 : 0,
                                }}
                              />
                            </div>
                          </div>
                          <div className="h-5 pt-1 text-center text-[10px] text-zinc-400 truncate">
                            {m.month}
                          </div>
                        </div>
                      );
              ...
              <p className="mt-3 text-center text-xs text-zinc-400">
                Pendapatan 12 bulan terakhir (Rp ribu)
              </p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-7">
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="flex items-center gap-1 text-sm font-semibold text-[#F5730C] hover:text-[#D9600A] transition-colors"
                >
                  Lihat Semua
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="mt-4 space-y-1">
                ...
                {data.recent_orders.map((o) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-xs font-semibold px-2.5 py-1 rounded-full ${statusMeta[o.status]?.badge || "bg-zinc-100 text-zinc-600"}`}
                    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 pb-4">
        <Link
          ...
          className="group bg-white rounded-2xl p-5 flex items-center gap-4 hover:shadow-sm transition-shadow"
        >
